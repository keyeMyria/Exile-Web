...
urlpatterns += [
    url(r'get/cliente/$',login_required(views.ListCliente.as_view()), name='list_cliente'),
    url(r'add/cliente/$',login_required(views.AddCliente.as_view()), name='add_cliente'),
    url(r'edit/cliente/(?P<pk>\d+)/$',login_required(views.EditCliente.as_view()), name='edit_cliente'),
    url(r'delete/cliente/(?P<pk>\d+)/$',login_required(views.DeleteCliente.as_view()), name='delete_cliente'),
...
#servicios de instancias de modulos
urlpatterns += [
    url(r'add/suscripcion/$',login_required(views.AddSuscripcion.as_view()), name='add_suscripcion'),
]
